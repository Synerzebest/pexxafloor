...
- Domaine canonique : `https://www.pexxafloor.be`, défini dans `lib/seo/metadata.ts`. Vercel gère la redirection de `pexxafloor.be` vers `www.pexxafloor.be`. Ne pas ajouter de redirection inverse dans Next.js : cela crée une boucle.
