...
type SurfaceCalculatorProps = {
  surface: string;
  setSurface: (val: string) => void;
};

export default function SurfaceCalculator({surface, setSurface}: SurfaceCalculatorProps) {
  const t = useTranslations('SurfaceCalculator');
